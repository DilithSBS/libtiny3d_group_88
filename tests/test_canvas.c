/*
    - This program was implemented to test if the canvas is working properly
    - Some 2D desgins are created on the canvas
    - The output is generated as /tests/visual_tests/test_canvas/test_canvas.pgm
    - It can be converted into .png by running the make command "make convert-test-canvas-png" on the terminal or run the python program "test_canvas_png.py".
*/
